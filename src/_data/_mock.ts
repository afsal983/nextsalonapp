...
export const _mock = {
  ...
  // Image
  image: {
    cover: (index: number) => `${CONFIG.assetsDir}/images/mock/cover/cover-${index + 1}.webp`,
    avatar: (index: number) => `${CONFIG.assetsDir}/images/mock/avatar/avatar-${index + 1}.webp`,
    travel: (index: number) => `${CONFIG.assetsDir}/images/mock/travel/travel-${index + 1}.webp`,
    course: (index: number) => `${CONFIG.assetsDir}/images/mock/course/course-${index + 1}.webp`,
    company: (index: number) => `${CONFIG.assetsDir}/images/mock/company/company-${index + 1}.webp`,
