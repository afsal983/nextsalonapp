    ...
    <ListItemAvatar>
      {notification.avatarUrl ? (
        ...
        >
          <Box
            component="img"
            src={`${CONFIG.assetsDir}/icons/notification/${(notification.type === 'order' && 'ic-order') || (notification.type === 'chat' && 'ic-chat') || (notification.type === 'mail' && 'ic-mail') || (notification.type === 'delivery' && 'ic-delivery')}.svg`}
