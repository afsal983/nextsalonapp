      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body2}>{invoice.Branches_organization.name}</Text>
            <Text style={styles.body2}>{invoice.Branches_organization.address}</Text>
            <Text style={styles.body2}>{invoice.Branches_organization.telephone}</Text>
          </View>
