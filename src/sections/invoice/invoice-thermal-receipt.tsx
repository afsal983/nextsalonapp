...
const InvoiceThermalReceipt = React.forwardRef<HTMLDivElement, ReceiptProps>(
  (props, ref) => (
    <div
      ref={ref}
      style={{
    ...
    >
        ...
        <tbody>
          <tr>
            <td style={{ textAlign: "center" }}>
              <img
                src={props.printinvoice.logourl}
                alt="logo"
                style={{ height: "82px", width: "158px" }}
              />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style={{ textAlign: "center" }}>
             ...
             {props.printinvoice.branchaddr}
              ...
              {props.printinvoice.branchaddr
                ? props.printinvoice.branchaddr.split("\n").map((item, i) => (
                    <p
                      style={{
                        fontSize: "14px",
                        margin: "0px",
          ...
          {props.printinvoice.authcode !== "" ? (
            <tr>
              <td style={{ textAlign: "center" }}>
                <p
                  style={{ fontSize: "14px", margin: "0px", fontWeight: "400" }}
                >
      ...
      >
        ...
        <tbody>
          {(props.printinvoice.itemlist || []).map((item, index) => (
            <tr>
              <td
                style={{
                  fontSize: "13px",
          ...
          >
            ...
            >
              {props.printinvoice.total}
            </td>
          </tr>
          {props.printinvoice.discount === "" ? null : (
            <tr>
              <td colSpan={2} />
              <td
                style={{
              ...
              >
                {props.printinvoice.discount}
              </td>
            </tr>
          )}
          {props.printinvoice.tip === "" ? null : (
            <tr>
              <td colSpan={2} />
              <td
                style={{
          ...
          <tr>
            ...
            >
              {props.printinvoice.taxname || "Tax"}
            </td>
            <td />
            <td
              style={{
      ...
      <table style={{ width: "100%" }}>
        <tbody>
          {props.printinvoice.customersavings === "" ? null : (
            <tr>
              <td style={{ textAlign: "center" }}>
                <p
                  style={{
