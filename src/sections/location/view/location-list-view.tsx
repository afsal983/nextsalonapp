...
import { type LocationItem, type LocationTableFilters } from 'src/types/location';
                  ...
                  {dataFiltered
                    ...
                    .map((row) => (
                      <LocationTableRow
                        ...
                        onSelectRow={() => {
                          table.onSelectRow(row.loc_id);
                        }}
                        onDeleteRow={() => {
                          handleDeleteRow(row.loc_id);
                        }}
                        onEditRow={() => {
                          handleEditRow(row.loc_id);
                        }}
                      />
                    ))}
