...
export default  function OrganizationListView () {
  ...
  const { data: organization,isLoading: isservicecategoryLoading, error: errorB } = useSWR('/api/salonapp/organization', fetcher);
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: t('salonapp.organization.organizations'), href: paths.dashboard.organization.root },
            { name: t('general.list') }
          ]}
          action={
            <Button
                  ...
                  {dataFiltered
                    ...
                    .map((row) => (
                      <OrganizationTableRow
                        ...
                        onSelectRow={() => { table.onSelectRow(row.org_id) }}
                        onDeleteRow={() => { handleDeleteRow(row.org_id) }}
                        onEditRow={() => { handleEditRow(row.org_id) }}
                      />
                    ))}
