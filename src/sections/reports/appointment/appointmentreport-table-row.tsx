  ...
  return (
    <Stack sx={{ typography: 'caption', color: 'text.secondary' }}>
      <ListItem key={params.row.bookingsource} disablePadding>
        <ListItemButton>
          <ListItemIcon>
            {(params.row.inventoryType === 'admin' && <SupervisorAccountIcon color="error" />) ||
              (params.row.inventoryType === 'Whatsapp' && <SupervisorAccountIcon />) ||
              (params.row.inventoryType === 'Google Business' && <GoogleIcon />) ||
              ...
              (params.row.inventoryType === 'Mobile Apps' && <MobileFriendlyIcon />) || (
                <SupervisorAccountIcon />
              )}
          </ListItemIcon>
          <ListItemText id={params.row.bookingsource} primary={params.row.bookingsource} />
        </ListItemButton>
      </ListItem>
    </Stack>
  );
