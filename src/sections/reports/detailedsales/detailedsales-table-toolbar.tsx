...
import { DetailedSalesReportTableFilters } from 'src/types/report';
...
export default function DetailedSalesTableToolbar({ filters, options }: Props) {
  const popover = usePopover();

  const local = useSetState<DetailedSalesReportTableFilters>({
