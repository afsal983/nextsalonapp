...
export default  function RetailBrandListView () {
  ...
  const { data: retail,isLoading: isretailLoading,  error: errorA } = useSWR('/api/salonapp/retailbrand', fetcher);
  ...
  const handleEditRow = useCallback(
    (id: string) => {
      router.push(paths.dashboard.retailbrands.edit(Number(id)))
    },
    [router]
  )
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: t('salonapp.retail_brand'), href: paths.dashboard.retails.root },
            { name: t('general.list') }
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.retailbrands.new}
              variant="contained"
