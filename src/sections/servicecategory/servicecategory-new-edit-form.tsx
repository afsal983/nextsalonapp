...
export default function ServiceCategoryNewEditForm ({ currentServiceCategory }: Props) {
  ...
  const NewProductSchema = Yup.object().shape({
    id: Yup.string(),
    name: Yup.string().required(t('salonapp.service.servicecategory.name_fvalid_error')),
  })
        ...
        <Grid xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            ...
            <Stack alignItems="flex-end" sx={{ mt: 3 }}>
              ...
              >
                {!currentServiceCategory ? t('salonapp.service.servicecategory.create_servicecategory') : t('salonapp.service.servicecategory.save_servicecategory')}
              </LoadingButton>
            </Stack>
          </Card>
        </Grid>
