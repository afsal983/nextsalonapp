  ...
  const defaultValues = useMemo(
    () => ({
      logocontent:
        ...
        "",
      emailid:
        currentSettings.find((item) => item.name === "emailid")?.value || "",
      adminemail:
        currentSettings.find((item) => item.name === "adminemail")?.value || "",
      telephone:
        currentSettings.find((item) => item.name === "telephone")?.value || "",
      language:
        currentSettings.find((item) => item.name === "language")?.value || "",
      address1:
        currentSettings.find((item) => item.name === "address1")?.value || "",
      address2:
        currentSettings.find((item) => item.name === "address2")?.value || "",
      startTime:
        currentSettings.find((item) => item.name === "startTime")?.value || "",
      endTime:
        currentSettings.find((item) => item.name === "endTime")?.value || "",
      timeFormat:
        currentSettings.find((item) => item.name === "timeFormat")?.value || "",
      timezone:
        currentSettings.find((item) => item.name === "timezone")?.value || "",
      homepage:
        currentSettings.find((item) => item.name === "homepage")?.value || "",
      currency:
        currentSettings.find((item) => item.name === "currency")?.value || "",
      theme: currentSettings.find((item) => item.name === "theme")?.value || "",
      defaulttelcode:
        currentSettings.find((item) => item.name === "defaulttelcode")?.value ||
        "",
      emailserver:
        currentSettings.find((item) => item.name === "emailserver")?.value ||
        "",
    }),
    [currentSettings]
  );
