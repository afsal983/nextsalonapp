...
export default function AccountView() {
  ...
  const { data: settingsData , isLoading, error: categoryError } = useSWR( `/api/salonapp/settings`, fetcher)
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      {currentTab === 'notifications' && <AccountNotifications currentSettings={settingsData.data}/>}
