...
export default function UserNewEditForm({
  ...
  const NewProductSchema = Yup.object().shape({
    ...
    branch_id: Yup.number()
      ...
      .required(t("general.branch_fvalid_error")),
    role_id: Yup.number()
      .positive(t("general.must_be_non_zero"))
      .required(t("general.roleid_fvalid_error")),
    address: Yup.string(),
    comment: Yup.string(),
    enabled: Yup.boolean(),
  });
          ...
          <Card sx={{ p: 3 }}>
            ...
            >
              ...
              <RHFTextField
                name="email"
                type="email"
                label={t("salonapp.user.email")}
              />
              <RHFTextField
                name="password"
                type="password"
                label={t("salonapp.user.password")}
              />

              <RHFTextField
                name="telephone"
                label={t("salonapp.user.telephone")}
              />
              ...
              <RHFTextField
                name="comments"
                label={t("salonapp.user.comments")}
              />
            ...
            <Stack alignItems="flex-end" sx={{ mt: 3 }}>
              ...
              >
                {!currentUser
                  ? t("salonapp.user.create_user")
                  : t("salonapp.user.save_user")}
              </LoadingButton>
            </Stack>
          </Card>
        </Grid>
