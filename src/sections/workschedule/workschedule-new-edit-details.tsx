...
export default function WorkScheduleNewEditDetails({ currentWorkSchedule, timeSlot, employee}: Props) {
          ...
          <Stack key={item.id} alignItems="flex-end" spacing={1.5}>
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={4} sx={{ width: 1 }}>
              ...
              <Stack direction="row" spacing={2} sx={{ flexWrap: 'wrap' }}>
                {
                  ["Monday", "Tuesday", "Wednesday", "Thursday", "Firday", "Saturday", "Sunday"].map((day: string, weekday : number)  => (
                    <RHFAutocomplete
